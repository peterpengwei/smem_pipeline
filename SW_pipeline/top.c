...
{
	printf("Entering top_main\n");
////////////////////////////////////////////////////////////////////
	FILE *test_RW;
	test_RW = fopen("test_RW.txt", "w");
	fputs("Memory profiling \n", test_RW);
  fclose(test_RW); 
	FILE *test_RW2;
	test_RW2 = fopen("test_RW2.txt", "w");
	fputs("Memory profiling \n", test_RW2);
  fclose(test_RW2); 
	FILE *test_RW3;
	test_RW3 = fopen("test_RW3.txt", "w");
	fputs("Memory profiling \n", test_RW3);
  fclose(test_RW3); 
////////////////////////////////////////////////////////////////////
	...
	if (ret == 0) {
		...
		fprintf(stderr, "\n[%s] Real time: %.3f sec; CPU: %.3f sec\n", __func__, realtime() - t_real, cputime()-t_cpu);
	}
	free(bwa_pg);
	return ret;
}
